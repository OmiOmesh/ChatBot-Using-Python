...
class ChatbotGUI:
    def __init__(self):
        ...
        self.window.configure(bg='#ffe6a3')  # Changed background color
    ...
    def create_widgets(self):
        ...
        self.main_frame = tk.Frame(self.window, bg='#7d7d99')  # Changed background color
        ...
        self.entry_frame = tk.Frame(self.main_frame, bg='#ffe6a3')  # Changed background color
